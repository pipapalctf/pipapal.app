...
import { Check, Loader2, UserIcon, KeyIcon, MapPinIcon, PhoneIcon, AtSign, AlertCircle, 
  ...
  SunIcon, MoonIcon, LaptopIcon, BellOffIcon, MessageSquare } from "lucide-react";
    ...
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <main className="flex-grow container mx-auto px-4 py-8">
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full max-w-3xl mx-auto">
          <TabsList className={`grid w-full ${isBusinessUser ? 'grid-cols-3 md:grid-cols-5' : 'grid-cols-3 md:grid-cols-4'} mb-8 gap-2`}>
