                    ...
                    <div className="space-y-1 p-2">
                      {conversations?.map((convo) => (
                        <div
                          key={convo.id}
                          onClick={() => setSelectedUser(convo.id)}
                          className="flex items-center gap-3 p-3 rounded-md cursor-pointer transition-colors hover:bg-accent"
                        >
                          <Avatar className="h-10 w-10 border border-muted">
                            <AvatarFallback className="bg-primary/10 text-primary font-medium">
                              {getInitials(convo.fullName || convo.username)}
              ...
              <div className="flex flex-col h-[calc(100vh-130px)]">
                ...
                <ScrollArea className="flex-1 p-4">
                  {messagesLoading ? (
                    ...
                    <div className="text-center py-12 text-muted-foreground">
                      <MessageSquare className="h-12 w-12 text-muted-foreground/30 mx-auto" />
                      <h3 className="text-lg font-medium mt-4 mb-2">No messages yet</h3>
                      <p className="text-sm text-muted-foreground">
                        Start a conversation by sending a message below.
                      </p>
                    </div>
